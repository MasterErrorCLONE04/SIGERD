                    ...
                    <form method="POST"
                        ...
                        <div>
                            ...
                            <x-text-input id="name"
                                          ...
                                          autofocus
                                          autocomplete="name"
                                          class="mt-2 w-full rounded-lg border-gray-300 dark:border-gray-600
                        ...
                        {{-- Email --}}
                        <div>
                            <x-input-label for="email" :value="__('Correo electrónico')" class="text-gray-700 dark:text-gray-200"/>
                        ...
                        {{-- Profile photo --}}
                        <div>
                            <x-input-label for="profile_photo" :value="__('Foto de perfil')" class="text-gray-700 dark:text-gray-200"/>
                            <div class="mt-2 flex items-center gap-5">
                                ...
                                @else
                                    <span class="inline-flex h-20 w-20 items-center justify-center rounded-full bg-gray-200 dark:bg-gray-700">
                        ...
                        <div class="flex items-center justify-end gap-3 pt-4">
                            ...
                            <x-primary-button class="!bg-indigo-600 hover:!bg-indigo-700 focus:ring-4 focus:ring-indigo-300 dark:focus:ring-indigo-800">
                                {{ __('Guardar cambios') }}
                            </x-primary-button>
                        </div>
                    </form>
